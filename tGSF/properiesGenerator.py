...
#python propertiesCreator.py -f C:\Users\sergio\workspace\Experiments\Multiple_Machines_Week\ -n 30 -c teikoku_1_ -s {(1;7)} -m 2
...
def main():
    ...
    workloadsPath = 'C:\\\\Users\\\\sergio\\\\workspace\\\\Experiments\\\\charges\\\\'
...
sites.site1.energy.sitePowerIdle = 1 \n\
sites.site1.energy.sitePowerIdle = 1 \n\
sites.site1.energy.siteTurnOnDelay = 0 \n\
sites.site1.energy.siteTurnOffDelay = 1 \n\
sites.site1.energy.numberChassises=1 \n\
sites.site1.energy.chassisPowerIdle = 0 \n\
sites.site1.energy.boardPowerIdle = 1 \n\
sites.site1.energy.corePowerIdle = 0 \n\
sites.site1.energy.corePowerWorking = 1 \n\
sites.site1.energy.coreTurnOffDelay = 1 \n\
