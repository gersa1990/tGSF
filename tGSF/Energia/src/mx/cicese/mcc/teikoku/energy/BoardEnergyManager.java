...
public class BoardEnergyManager extends AbstractEnergyManager{
	
	/*
	 * Constructores
	 */
	public BoardEnergyManager(Site s)
	{
		super(s);
		this.setPidle(eC.getBoardPowerIdle(s));
		this.setTurnOnConsumption(eC.getBoardPowerTurnOn(s));
	}
