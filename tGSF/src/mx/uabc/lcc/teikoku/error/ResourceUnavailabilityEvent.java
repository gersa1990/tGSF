 ...
 */
public class ResourceUnavailabilityEvent extends Event {
	// Atributos
   Error errorEvent;
   Site site;
    //Constructores
    public ResourceUnavailabilityEvent(final Instant time, Error e, Site s)
	{
    ...
    {
    	return EventType.UNAVAILABILITY.ordinal();
    }
}
