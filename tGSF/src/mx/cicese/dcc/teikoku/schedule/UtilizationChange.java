 ...
 * 
 */
public class UtilizationChange implements Comparable<UtilizationChange> {

	/**
	 * TODO: not yet commented
	 * 
	 */
	private TemporalSchedule schedule;
	 ...
	 * @param schedule
	 */
	public UtilizationChange(TemporalSchedule schedule) {
	 ...
	 * @param timestamp
	 */
	public UtilizationChange(TemporalSchedule schedule, Instant timestamp) {
		this.schedule = schedule;
		this.timestamp = timestamp;
		
		this.occupiedResources = new ResourceBundleBitVectorImpl(this.schedule.getSiteInformation());
		this.freeResources = new ResourceBundleBitVectorImpl(
				this.schedule.getSiteInformation(), 
				this.schedule.getSiteInformation().getProvidedResources().toArray());
		
		
		this.freeResources.add(this.schedule.getSiteInformation().getLentResources());
	...
	public void setOccupiedResources(ResourceBundle r) {
		this.occupiedResources = r;
	}
	 ...
	 * @return
	 */
	public void setInvolvedOccupations(int o) {
		this.involvedOccupations  = o;
	}
	...
	/* ADDED */
	public void setSchedule(TemporalSchedule newCopy) {
