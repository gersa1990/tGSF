...
public class MLp_eff implements mx.cicese.dcc.teikoku.scheduler.strategy.rigid.RStrategy {
	...
	public AllocationEntry schedule(Job job) {
		 ...
		 * effi - the energy efficiency of machine M_i
		 */
