...
/**
 * This is the StandardActivityBroker, which espacially knows all other activityBroker in the Grid
 * and doing nothing more than the standard abstract-class
 * 
 ...
 *
 */
public class StandardActivityBroker extends AbstractActivityBroker {
	
	/**
	 * returns the list of known ActivityBrokers and initializes it on start
