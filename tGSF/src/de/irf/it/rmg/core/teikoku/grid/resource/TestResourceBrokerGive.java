...
/**
 * This is the TestResourceBrokerGive, which especially knows all other resourceBroker in the Grid
 ...
 *
 */
public class TestResourceBrokerGive extends AbstractResourceBroker {
	...
	public void offer(ResourceDelegationSession session)
		...
		throw new OfferingVetoException();
	}
