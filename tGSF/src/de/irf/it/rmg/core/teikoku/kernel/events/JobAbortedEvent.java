 ...
 * 
 */
public class JobAbortedEvent extends Event {

	/**
	 * TODO: not yet commented
	 * 
	 */
	private Job abortedJob;
	 ...
	 * @param location
	 */
	public JobAbortedEvent(final Instant timestamp, final Job abortedJob,
			final Site location) {

		super(timestamp, location.getUUID().toString(), location);
		this.abortedJob = abortedJob;
	}
	 ...
	 * @return
	 */
	final public Job getAbortedJob() {
		return this.abortedJob;
	}
	...
	protected int getOrdinal() {
		return EventType.JOB_ABORTED.ordinal();
	}
}
