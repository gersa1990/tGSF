 ...
 * 
 */
public class ReservationEndEvent extends Event {
	 ...
	 * @param location
	 */
	public ReservationEndEvent(final Instant timestamp,
			final Reservation reservation, final Site location) {
		super(timestamp, location.getUUID().toString());
	...
	protected int getOrdinal() {
		...
		return EventType.RESERVATION_ENDED.ordinal();
	}
}
