...
/**
 * Indicated that the given contact string is not valid.
 * 
...
public class InvalidContactStringException extends DrmsInitException {
	 ...
	 * @see Serializable 
	 */
	final private static long serialVersionUID = -330693044643185128L;
	 ...
	 */
	public InvalidContactStringException(String message) {
		super(message);
	}
