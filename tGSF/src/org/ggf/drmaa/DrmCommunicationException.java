...
/**
 * Indicates that the DRM system could not be contacted.
 * 
...
public class DrmCommunicationException extends DrmaaException {
	 ...
	 * @see Serializable
	 */
	final private static long serialVersionUID = 5231039369904727664L;
	 ...
	 */
	public DrmCommunicationException(String message) {
		super(message);
	}
