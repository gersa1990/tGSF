...
/**
 * Indicated that the {@link DelegationSession#wait()} or
 * {@link DelegationSession#synchronize(java.util.List, long, boolean)} call returned
 * before all selected jobs entered the <code>DONE</code> or
...
public class ExitTimeoutException extends DrmaaException {
	 ...
	 * @see Serializable
	 */
	final private static long serialVersionUID = 1601278394829072919L;
