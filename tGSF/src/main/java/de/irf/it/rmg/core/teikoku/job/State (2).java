	...
	public boolean validateStateChange(State source) {
		...
		switch (this) {
			...
			case RELEASED:
				...
				break;
			case QUEUED:
				result = RELEASED.equals(source) || QUEUED.equals(source) || ABORTED.equals(source) || SCHEDULED.equals(source) || RESUMED.equals(source);
				break;
			case SCHEDULED:
				result = QUEUED.equals(source) || SCHEDULED.equals(source);
				break;
			case STARTED:
				result = SCHEDULED.equals(source) || RESUMED.equals(source);
				break;
			case RESUMED:
				result = INTERRUPTED.equals(source)
			...
			case FAILED:
				...
				break;
			case INTERRUPTED:
				result = STARTED.equals(source)||RESUMED.equals(source);
				break;
			default:
				result = false;
				break;
