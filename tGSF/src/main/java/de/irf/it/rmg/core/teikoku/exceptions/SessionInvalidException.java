...
/**
 * This Exception is thrown when a job within an expired session is tried to be accepted
 * 
 ...
 * 
 */
final public class SessionInvalidException extends Exception {

	/**
	 * TODO: not yet commented
	 * 
	 */
	private static final long serialVersionUID = -3928745242070294L;
