...
public class JobRejectedEvent extends Event {

	Site site;
	Job job;
	
	public JobRejectedEvent (final Instant time, Job j, Site s)
	{
	...
	protected int getOrdinal() {
		...
		return EventType.JOB_REJECTED_EVENT.ordinal();
	}
