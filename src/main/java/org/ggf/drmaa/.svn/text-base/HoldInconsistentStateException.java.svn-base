...
/**
 * Indicated that the job cannot be moved to a <code>HOLD</code> state.
 * 
...
public class HoldInconsistentStateException extends InconsistentStateException {
	 ...
	 * @see Serializable 
	 */
	final private static long serialVersionUID = -5616729711561880095L;
	 ...
	 */
	public HoldInconsistentStateException(String message) {
		super(message);
	}
